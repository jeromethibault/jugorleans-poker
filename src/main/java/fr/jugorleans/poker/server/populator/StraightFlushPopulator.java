...
/**
 * Le populator pour une combinaison de type "STRAIGHT_FLUSH"
 */
public class StraightFlushPopulator implements CombinationPopulator {
    ...
    public boolean handleCombination(Combination combination) {
        return combination.equals(Combination.STRAIGHT_FLUSH);
    }
    ...
    public CombinationStrength populate(List<Card> list) {
        CombinationStrength combinationStrength = CombinationStrength.name(Combination.STRAIGHT_FLUSH);
